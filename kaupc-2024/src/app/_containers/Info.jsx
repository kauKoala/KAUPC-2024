...
const Info = () => {
    return (
        <div className="info-section-container">
            ...
            <div className="info-detail">
                <div><li>2024년 8월 3일 13시 ~ 18시 (4시간 진행)</li></div>
                <div><li>한국 항공 대학교 강의동 1층에서 진행 예정</li></div>
                <div><li>노트북 지참 필수</li></div>
                <div><li>교내 역량 관리 시스템을 통한 온라인 접수</li></div>
            ...
            <div className="info-header">대회 규정 사항</div>
            <div className="info-detail">
                <div><li>개인전이며, 약 4시간동안 주어진 프로그래밍 문제를 해결하는 대회입니다.</li></div>
                <div><li>chatGPT 및 copilot 사용은 금지되며, 적발 시 퇴장될 수 있습니다.</li></div>
                <div><li>문제는 총 10문제가 출제됩니다.</li></div>
                <div><li>다른 사람과 문제에 대해 어떤 형태로든 커뮤니케이션 하는 것은 부정행위로 간주됩니다.</li></div>
                <div><li>위의 유의사항을 위반하는 경우 부정행위로 간주되어 실격되며, 수상하였더라도 수상이 취소될 수 있습니다.</li></div>
            </div>
            <div className="info-header">참가자 혜택</div>
            <div className="info-detail">
            <div><li>참가자 전원에게는 학생활동 마일리지가 지급될 예정입니다.</li></div>
            </div>
        </div>
    );
};
