...
const Info = () => {
    return (
        <div className="info-section-container">
            ...
            <div className="info-detail">
                <div>교내 역량 관리 시스템을 통한 온라인 접수</div>
                <div>교내 프로그래밍 동아리 및 업체 공동 출제</div>
                <div>코드 트리 플랫폼을 통하여 답안 제출 및 자동 채점</div>
                <div>Python3, C++, JAVA 등의 언어 지원</div>
            </div>
            ...
            <div className="info-detail">
                ...
                <div>
                    이 외에도 우수 참여자 및 이벤트 성 시상이 추가로 있을 예정입니다.
                </div>
            </div>
        </div>
    );
